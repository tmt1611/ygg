...
/**
 * A robust text wrapping function for SVG <text> elements using D3.
 * @param {d3.Selection} textSelection - The D3 selection of <text> elements to wrap.
 * @param {number} width - The maximum width in pixels for the text.
 * @param {number} [maxLines=3] - The maximum number of lines to wrap to.
 */
export const wrapSvgText = (textSelection, width, maxLines = 3) => {
